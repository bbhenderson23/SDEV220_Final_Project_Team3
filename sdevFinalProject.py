...
def search_record_window():
    ...
    def search_selection():
        ...
        def create_results(oid_records, f_name_records, l_name_records, address_records, city_records, state_records,
            ...
            oid_results = Label(results_frame, text=oid_records)
            oid_results.grid(row=9, column=0)
            f_name_results = Label(results_frame, text=f_name_records)
            f_name_results.grid(row=9, column=1)
            l_name_results = Label(results_frame, text=l_name_records)
            l_name_results.grid(row=9, column=2)
            address_results = Label(results_frame, text=address_records)
            address_results.grid(row=9, column=3)
            city_results = Label(results_frame, text=city_records)
            city_results.grid(row=9, column=4)
            state_results = Label(results_frame, text=state_records)
            state_results.grid(row=9, column=5)
            zip_code_results = Label(results_frame, text=zip_code_records)
            zip_code_results.grid(row=9, column=6)
            phone_results = Label(results_frame, text=phone_records)
            phone_results.grid(row=9, column=7)
            email_results = Label(results_frame, text=email_records)
            email_results.grid(row=9, column=8)
            gpa_results = Label(results_frame, text=gpa_records)
            gpa_results.grid(row=9, column=9)
            grade_level_results = Label(results_frame, text=grade_level_records)
    ...
    oid_head.grid(row=8, column=0, sticky=W, padx=10)
    f_name_head = Label(results_frame, text="First Name")
    f_name_head.grid(row=8, column=1, sticky=W, padx=10)
    l_name_head = Label(results_frame, text="Last Name")
    l_name_head.grid(row=8, column=2, sticky=W, padx=10)
    address_head = Label(results_frame, text="Address")
    address_head.grid(row=8, column=3, sticky=W, padx=10)
    city_head = Label(results_frame, text="City")
    city_head.grid(row=8, column=4, sticky=W, padx=10)
    state_head = Label(results_frame, text="State")
    state_head.grid(row=8, column=5, sticky=W, padx=10)
    zip_code_head = Label(results_frame, text="Zip Code")
    zip_code_head.grid(row=8, column=6, sticky=W, padx=10)
    phone_head = Label(results_frame, text="Phone Number")
    phone_head.grid(row=8, column=7, sticky=W, padx=10)
    email_head = Label(results_frame, text="Email")
    email_head.grid(row=8, column=8, sticky=W, padx=10)
    gpa_head = Label(results_frame, text="GPA")
    gpa_head.grid(row=8, column=9, sticky=W, padx=10)
    grade_level_head = Label(results_frame, text="Grade Level")
    grade_level_head.grid(row=8, column=10, sticky=W, padx=10)
