...
def update_record_window():
    ...
    def populate_records(results):
        ...
        def change_database(search_key, f_name_update,
                            l_name_update,
                            address_update,
                            city_update,
                            state_update,
        ...
        def update_records(n):
            ...
            def update_pop_window():
                ...
                address_records = results[0][2]
                city_records = results[0][3]
                state_records = results[0][4]
                zip_code_records = results[0][5]
                phone_area_records = results[0][6]
                phone_prefix_records = results[0][7]
                phone_line_records = results[0][8]
                email_records = results[0][9]
                gpa_records = results[0][10]
                grade_level_records = results[0][11]
                ...
                phone_area_update.insert(0, phone_area_records)
                phone_prefix_update.insert(0, phone_prefix_records)
                phone_line_update.insert(0, phone_line_records)
        ...
        for i in range(len(results)):
            ...
            #### These need to be changed from Entry to label. Will probably have to redo surrounding code
            ...
            phone_line = Entry(update_frame, width=3)
            ...
            phone_prefix.insert(0, phone_area_records[i])
            phone_line.insert(0, phone_area_records[i])
